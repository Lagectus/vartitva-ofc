...
export default function NumbersSection() {
  ...
  const stats = [
    ...
    },
    {
      ...
      description: "Dedicated supply channels in Delhi, Gurugram & Sonipat",
      icon: MapPin,
      color: "text-[#e11d48]",
    },
    {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-b from-white via-slate-50/80 to-white relative overflow-hidden">
